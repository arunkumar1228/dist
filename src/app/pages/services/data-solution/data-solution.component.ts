...
@Component({
  selector: 'app-data-solution',
  templateUrl: './data-solution.component.html',
  styleUrls: ['./data-solution.component.scss']
})
export class DataSolutionComponent implements OnInit {
  currentUrl: string;
  whatWeOffer:any;
  ...
  itemsPerPage: number = 3;
    constructor(private httpClient: HttpClient,private caseStudyService:CaseStudyService,private titleService: Title,private metaService: Meta,private location:Location,private renderer: Renderer2,private router: Router) { 
      this.titleService.setTitle('Data Analytics Services for Informed Decision-Making');
    this.metaService.addTag({ name: 'description', content:"Explore our cutting-edge Data Analytics Services. Leverage data for actionable insights, strategic planning, and business optimization. Elevate your decision-making today."});
